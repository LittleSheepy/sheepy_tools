...
class YOLO2VOCConvert:
    def __init__(self, txts_path, xmls_path, imgs_path):
        ...
        self.classes = ["heidian", "huahen", "liehen", "diuqiu","quejiao"]  # 注意：这里根据自己的类别名称及种类自行更改
    ...
    def yolo2voc(self):
        ...
        if True:  # 注意：./Annotation_txt 不要把classes.txt文件放进去
            ...
            for img_name, txt_name in map_imgs_txts:
                ...
                for object_info in all_objects:
                    if not object_info[0] in ["1"]:continue
                    # 开始创建标注目标的label信息的标签
...
if __name__ == '__main__':
    ...
    # yolo格式txt标签文件相对路径
    txts_path1 = r'C:\Users\jxcao\Desktop\data\auto_label\pre_output21\huahen/'
    # 转化为voc格式xml标签文件存储的相对路径
    xmls_path1 = r'C:\Users\jxcao\Desktop\data\auto_label\pre_output21\huahen_xml/'
    # 存放图片的相对路径
    imgs_path1 = r'C:\002workspace\01code\output21/'
